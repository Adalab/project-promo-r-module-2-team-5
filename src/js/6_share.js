      ...
      headers: {
            ...
            .then((responseJson) => {
                if(responseJson.success) {
                  ...
                  const errorTextEl = document.querySelector('.form__collapsible__errorText');
                  errorTextEl.remove();
                  ...
                  twitterBtn.href = `https://twitter.com/intent/tweet?text=¡Os%20comparto%20la%20mejor%20tarjeta%20del%20mundo!&url=${responseJson.cardURL}`;
                    ...
                    const errorText = document.createTextNode("Algo ha ido mal. Asegúrate de rellenar todos los campos y adjuntar una imagen.");
